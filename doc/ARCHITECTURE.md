...
│  project/service.go - 项目/会话/消息/资源 CRUD                 │
...
│  projects[] / currentProject← 项目数据（轻量级场景）        │
...
| API 对象 | 职责 | 关键方法 |
|---|---|---|
| `projectApi` | 项目/会话/消息/资源 CRUD | list, create, uploadResource, generatePageFromOutlineStream |
