...
本文档在 [`doc/bak/THIRD_PARTY_INTEGRATION.md`](bak/THIRD_PARTY_INTEGRATION.md) 的第三方接入说明之上，结合当前仓库内 **yilimsdk**、**backend chat 服务**、**前端 apiStore** 的真实实现，统一术语、远端状态、数据流与异常处理策略，便于后续 SDK 与前端体验重构。
